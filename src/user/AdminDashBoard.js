...
const AdminDashBoard = () => {
        ...
        return (
            <div className="card">
                ...
                <ul className="list-group">
                    ...
                    <li className="list-group-item">
                        <Link to="/admin/manage/products" className="nav-link text-success">Manage Products</Link>
                    </li>
                    <li className="list-group-item">
    ...
    const adminRightSide = () => {
        return (
            <div className="card mb-4">
                ...
                <ul className="list-group">
                    <li className="list-group-item">
                        <span className="badge badge-success mr-2">Name:</span> { name[0].toUpperCase() + name.slice(1) }
                    </li>
                    <li className="list-group-item">
    ...
    return (
        <Base title="Admin Dashboard" description="Hi, you are an admin of this site" className="container bg-success p-4">
            <div className="row">
